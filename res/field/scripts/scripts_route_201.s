...
Route201_Briefcase:
    LockAll
    // ROM hack (intro skip v2): fully self-contained briefcase. NO Prof. Rowan /
    // rival / counterpart objects are touched, so it works with the opening
    // cutscene skipped. First interaction = pick a starter + first rival battle;
    // interact again = the other two starters.
